...
gem 'opal', '1.1.1'
gem 'opal-rails', '~> 2.0.1'
gem 'opal-async', '~> 1.4.0' #, path: '../opal-async'
gem 'opal-jquery'
gem 'glimmer-dsl-opal', '~> 0.25.4' #, path: '../glimmer-dsl-opal'
...
# gem 'glimmer' , path: '../glimmer' # TODO disable line before pushing
